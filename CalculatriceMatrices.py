class CalculatriceMatrices:
    ...
    def labyrinthe(m: list[list[int]], rangee:int, colonne:int) -> bool :
        """
        18★ Détermine si un chemin existe dans la matrice m à partir de la case r, c
        ...
        Le chemin peut aller à gauche, en haut, à droite ou en bas (pas de diagonales)
            ...
            Parameters:
                m(list[list[int]]): Une matrice d'entiers quelconque
                rangee(int): La coordonnée rangée du point de départ
                colonne(int): La coordonnée colonne du point de départ
        
            Returns:
                Vrai s'il existe un chemin dans m à partir de la case (r, c) vers une case contenant un -1.
        """
        return False
    

    def chemin_labyrinthe(m: list[list[int]], rangee: int, colonne: int, depart: int) -> bool:
        """
        15★ Trouve un chemin, s'il en existe un, dans la matrice m à partir de la case r, c
        vers une case contenant un -1.
        ...
        Le chemin trouvé n'est pas nécessairement le plus court, mais on ne revient jamais sur nos pas.
            ...
            Parameters:
                m(list[list[int]]): Une matrice d'entiers quelconque
                rangee(int): La coordonnée rangée du point de départ
                ccolonne(int): La coordonnée colonne du point de départ
                depart(int): Le premier nombre à écrire dans le labyrinthe pour représenter le chemin
        
            Returns:
                Vrai s'il existe un chemin dans m à partir de la case (rangee, colonne) vers une case contenant un -1.
        """
        return False    
